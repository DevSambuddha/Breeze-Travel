        ...
        <div className="d-flex gap-xxl">
          <div className="d-flex direction-column">
            <span className="span d-flex align-center gap">
              <span className="material-symbols-outlined">apps</span>Kitchen
            </span>
            <span className="span d-flex align-center gap">
              <span className="material-symbols-outlined">apps</span>Free
              parking on premises
          ...
          <div className="d-flex direction-column">
            <span className="span d-flex align-center gap">
              <span className="material-symbols-outlined">apps</span>Wifi
            </span>
            <span className="span d-flex align-center gap">
              <span className="material-symbols-outlined">apps</span>Washing
              Machine
            </span>
            <span className="span d-flex align-center gap">
              <span className="material-symbols-outlined">apps</span>Patio or
              Balcony
            </span>
          </div>
        </div>
